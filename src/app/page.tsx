  ...
  return (
    <main style={{minHeight:'100vh',display:'grid',placeItems:'center',background:'#000',color:'#fff',fontFamily:'Inter,system-ui,sans-serif',textAlign:'center',padding:'40px'}}>
      <div>
        ...
        <a href="https://tally.so/r/3xAMPLE" style={{background:'#fff',color:'#000',padding:'12px 18px',borderRadius:8,fontWeight:700,textDecoration:'none'}}>Join the Waitlist</a>
